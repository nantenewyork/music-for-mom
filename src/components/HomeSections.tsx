            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 gap-6 sm:gap-10 md:grid-cols-3">
                    ...
                    <div className="group flex flex-col gap-6 sm:gap-8 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-10 bg-white/40 border border-white/40 transition-all hover:-translate-y-2 hover:bg-white/60 hover:shadow-2xl">
                        ...
                        <div>
                            <h3 className="premium-serif text-xl sm:text-2xl font-bold mb-3" style={{ color: colors.warmSlate }}>{t('homeSections.goldenTitle')}</h3>
                            <p className="text-sm font-medium leading-relaxed" style={{ color: `${colors.warmSlate}b3` }}>
                                {t('homeSections.goldenDesc')}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="group flex flex-col gap-6 sm:gap-8 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-10 bg-white/40 border border-white/40 transition-all hover:-translate-y-2 hover:bg-white/60 hover:shadow-2xl">
                        ...
                        <div>
                            <h3 className="premium-serif text-xl sm:text-2xl font-bold mb-3" style={{ color: colors.warmSlate }}>{t('homeSections.naturalTitle')}</h3>
                            <p className="text-sm font-medium leading-relaxed" style={{ color: `${colors.warmSlate}b3` }}>
                                {t('homeSections.naturalDesc')}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="group flex flex-col gap-6 sm:gap-8 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-10 bg-white/40 border border-white/40 transition-all hover:-translate-y-2 hover:bg-white/60 hover:shadow-2xl">
                        ...
                        <div>
                            <h3 className="premium-serif text-xl sm:text-2xl font-bold mb-3" style={{ color: colors.warmSlate }}>{t('homeSections.soulfulTitle')}</h3>
                            <p className="text-sm font-medium leading-relaxed" style={{ color: `${colors.warmSlate}b3` }}>
                                {t('homeSections.soulfulDesc')}
                            </p>
                        </div>
                    </div>
                </div>
